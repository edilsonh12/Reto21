            ...
            if(response.error){
                ...
                if(response.error){
                    ...
                    if(response.error){
                        ...
                        const response = await pool.query('insert into tipo_usuario_nutri (id_plan_nutri_nutri,documento_nutri_nutri) values ($1,$2)',[id_plan_nutri_nutri,documento_nutri_nutri]);
